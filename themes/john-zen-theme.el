...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(magit-branch                        ((,class (:foreground ,ujelly-red-2 :background ,john-bg))))
   `(magit-diff-add                      ((t (:foreground ,john-greengreen :background ,john-bg))))
   `(magit-diff-del                      ((t (:foreground ,john-red :background ,john-bg))))
   ...
   `(magit-section-title                 ((,class (:foreground ,john-orange :background ,john-black :underline t))))
