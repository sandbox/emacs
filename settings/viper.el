...
(defun viper-cua-region-fix()
  ...
  (define-key viper-vi-basic-map "P" 'vimpulse-put-and-indent)
  (define-key viper-vi-basic-map "gf" 'ido-find-file)
  )
